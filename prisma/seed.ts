...
const permissions = [
  ...
  ['help_guides.read', 'View contextual system and organization help guides.'],
  ['help_guides.manage', 'Create and edit organization help guide drafts.'],
  ['help_guides.publish', 'Publish and retire organization help guides.'],
